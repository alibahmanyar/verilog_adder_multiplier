...
جمع‌کننده‌ی \lr{shift-Add} در چندین کلاک کار می‌کند، اما می‌توانیم بدون استفاده از کلاک و تنها با استفاده از یک مدار ترکیبی نیز عملیات جمع را پیاده‌سازی کنیم:
